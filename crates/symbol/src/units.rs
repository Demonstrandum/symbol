#![allow(dead_code)] // Complete unit families are intentionally available together.
...
const SECONDS_PER_MINUTE_VALUE: u64 = 60;
const BINARY_UNIT_SCALE: u64 = 1024;

pub const SECONDS_PER_MINUTE: u64 = SECONDS_PER_MINUTE_VALUE;
...
pub const KIB: u64 = BINARY_UNIT_SCALE;
pub const MIB: u64 = BINARY_UNIT_SCALE * KIB;
pub const GIB: u64 = BINARY_UNIT_SCALE * MIB;
pub const TIB: u64 = BINARY_UNIT_SCALE * GIB;
pub const PIB: u64 = BINARY_UNIT_SCALE * TIB;
pub const EIB: u64 = BINARY_UNIT_SCALE * PIB;
